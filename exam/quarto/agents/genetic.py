...
from .genome import Genome,generate_rules
...
class GeneticProgramming:
    ...
    def cross_oversplit(self,genome1: Genome,genome2: Genome):
        ...
        return c_rules[:random.randint(5,9)],p_rules[:random.randint(5,9)]
    ...
    def evolve(self,iterations):
        ...
        for i in range(iterations):
            ...
            for o in range(self.__OFFSPRING_SIZE__ if i%4 else int(self.__OFFSPRING_SIZE__*0.8)):
                #always mutate
                cross=True
